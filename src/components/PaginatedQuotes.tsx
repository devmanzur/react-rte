...
import { fetchQuotesByPage, QuotesData } from 'src/api/quoteApi'
...
const PaginatedQuotes = () => {
    ...
    const {
        ...
        isSuccess,
        isError,
        isPreviousData, } = useQuery<QuotesData>(['quotes', page], () => fetchQuotesByPage(page), {
    ...
    return (
        <div className="py-8 max-w-2xl mx-auto">
            <div>
                ...
                {isSuccess ? (
                    <div>
                        <div className="overflow-y-auto divide-y"> {quotes?.quotes.map((quote) => {
                            return (
                                <blockquote
                                    key={quote.id}
